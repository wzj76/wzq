...
namespace duole
{
    string EncodeDecodeUtil::getMd5Encode(const string &sData)
    {
        return MD5(sData).toString();
    }

    string EncodeDecodeUtil::getBase64Encode(const string &sData)
    {
        string sRet = "";
    ...
    string EncodeDecodeUtil::getBase64Decode(const string &sData)
    {
    ...
    string EncodeDecodeUtil::getBase64UrlEncode(const string &sData)
    {
        return CBase64::UrlEncode(sData);
    }

    string EncodeDecodeUtil::getBase64UrlDecode(const string &sData)
    {
        return CBase64::UrlDecode(sData);
    }

    string EncodeDecodeUtil::getXorEncode(const string &sData, const string &sKey)
    {
        string sRet = sData;
    ...
    string EncodeDecodeUtil::getRot47Encode(const string &sData)
    {
        string sRet = sData;
    ...
    string EncodeDecodeUtil::getCustomEncodedUrl(const string &sUrl)
    {
        string sRet = sUrl;
        string sSeparator = "?";
    ...
    unsigned char* EncodeDecodeUtil::getFileDataXxteaEncrypt(const string &sFilePath, const string &sKey, ssize_t* pSize)
    {
    ...
    unsigned char* EncodeDecodeUtil::getFileDataXxteaDecrypt(const string &sFilePath, const string &sKey, ssize_t* pSize)
    {
        unsigned char* pRet = nullptr;
        if (!sKey.empty())
        {
    ...
    void EncodeDecodeUtil::generateXxteaEncryptFile(const string &sSrcFile, const string &sFileName, const string &sKey)
    {
        ssize_t nSize = 0;
        FileUtils* pUtils = FileUtils::getInstance();
    ...
    void EncodeDecodeUtil::generateXxteaDecryptFile(const string &sSrcFile, const string &sFileName, const string &sKey)
    {
        ssize_t nSize = 0;
        FileUtils* pUtils = FileUtils::getInstance();
        string sFullPath = pUtils->fullPathForFilename(sSrcFile);
