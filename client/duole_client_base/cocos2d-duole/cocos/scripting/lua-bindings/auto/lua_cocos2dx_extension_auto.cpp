...
// AssetsManager
#define STRING_ASSETS_MANAGER                          cocos2d::StringUtils::format("%s%s", "Assets", "Manager").c_str()
// cc.AssetsManager
#define STRING_CC_ASSETS_MANAGER                       cocos2d::StringUtils::format("%s.%s", "cc", STRING_ASSETS_MANAGER).c_str()
// lua_cocos2dx_extension_AssetsManager
#define STRING_LUA_ASSETS_MANAGER                      cocos2d::StringUtils::format("%s_%s", "lua_cocos2dx_extension", STRING_ASSETS_MANAGER).c_str()
// AssetsManagerEx
#define STRING_ASSETS_MANAGER_EX                       cocos2d::StringUtils::format("%s%s%s", "Assets", "Manager", "Ex").c_str()
// cc.AssetsManagerEx
#define STRING_CC_ASSETS_MANAGER_EX                    cocos2d::StringUtils::format("%s.%s", "cc", STRING_ASSETS_MANAGER_EX).c_str()
// lua_cocos2dx_extension_AssetsManagerEx
#define STRING_LUA_ASSETS_MANAGER_EX                   cocos2d::StringUtils::format("%s_%s", "lua_cocos2dx_extension", STRING_ASSETS_MANAGER_EX).c_str()
// EventAssetsManagerEx
#define STRING_EVENT_ASSETS_MANAGER_EX                 cocos2d::StringUtils::format("%s%s%s", "EventAssets", "Manager", "Ex").c_str()
// cc.EventAssetsManagerEx
#define STRING_CC_EVENT_ASSETS_MANAGER_EX              cocos2d::StringUtils::format("%s.%s", "cc", STRING_EVENT_ASSETS_MANAGER_EX).c_str()
// lua_cocos2dx_extension_EventAssetsManagerEx
#define STRING_LUA_EVENT_ASSETS_MANAGER_EX             cocos2d::StringUtils::format("%s_%s", "lua_cocos2dx_extension", STRING_EVENT_ASSETS_MANAGER_EX).c_str()
// Manifest
#define STRING_MANIFEST                                cocos2d::StringUtils::format("%s%s", "Manifest", "").c_str()
// cc.Manifest
#define STRING_CC_MANIFEST                             cocos2d::StringUtils::format("%s.%s", "cc", STRING_MANIFEST).c_str()
// lua_cocos2dx_extension_Manifest
#define STRING_LUA_MANIFEST                            cocos2d::StringUtils::format("%s_%s", "lua_cocos2dx_extension", STRING_MANIFEST).c_str()

// EventListenerAssetsManagerEx
#define STRING_EVENT_LIS_ASSETS_MANAGER_EX             cocos2d::StringUtils::format("%s%s","EventListener", STRING_ASSETS_MANAGER_EX).c_str()
// cc.EventListenerAssetsManagerEx
#define STRING_CC_EVENT_LIS_ASSETS_MANAGER_EX          cocos2d::StringUtils::format("%s.%s", "cc", STRING_EVENT_LIS_ASSETS_MANAGER_EX).c_str()
// lua_cocos2dx_extension_EventListenerAssetsManagerEx
#define STRING_LUA_EVENT_LIS_ASSETS_MANAGER_EX        cocos2d::StringUtils::format("%s_%s", "lua_cocos2dx_extension", STRING_EVENT_LIS_ASSETS_MANAGER_EX).c_str()

// cc.AssetsManager:%s
#define STRING_CC_ASSETS_MANAGER_WITH(NAME)            cocos2d::StringUtils::format("%s%s%s", STRING_CC_ASSETS_MANAGER, ":", (NAME)).c_str()
// lua_cocos2dx_extension_AssetsManager_%s
#define STRING_LUA_ASSETS_MANAGER_WITH(NAME)           cocos2d::StringUtils::format("%s%s%s", STRING_LUA_ASSETS_MANAGER, "_", (NAME)).c_str()
// cc.AssetsManagerEx:%s
#define STRING_CC_ASSETS_MANAGER_EX_WITH(NAME)         cocos2d::StringUtils::format("%s%s%s", STRING_CC_ASSETS_MANAGER_EX, ":", (NAME)).c_str()
// lua_cocos2dx_extension_AssetsManagerEx_%s
#define STRING_LUA_ASSETS_MANAGER_EX_WITH(NAME)        cocos2d::StringUtils::format("%s%s%s", STRING_LUA_ASSETS_MANAGER_EX, "_", (NAME)).c_str()
// cc.EventAssetsManagerEx:%s
#define STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(NAME)   cocos2d::StringUtils::format("%s%s%s", STRING_CC_EVENT_ASSETS_MANAGER_EX, ":", (NAME)).c_str()
// lua_cocos2dx_extension_EventAssetsManagerEx_%s
#define STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(NAME)  cocos2d::StringUtils::format("%s%s%s", STRING_LUA_EVENT_ASSETS_MANAGER_EX, "_", (NAME)).c_str()
// cc.Manifest:%s
#define STRING_CC_MANIFEST_WITH(NAME)                  cocos2d::StringUtils::format("%s%s%s", STRING_CC_MANIFEST, ":", (NAME)).c_str()
// lua_cocos2dx_extension_Manifest_%s
#define STRING_LUA_MANIFEST_WITH(NAME)                 cocos2d::StringUtils::format("%s%s%s", STRING_LUA_MANIFEST, "_", (NAME)).c_str()
// cc.EventListenerAssetsManagerEx:%s
#define STRING_CC_EVENT_LIS_ASSETS_MANAGER_EX_WITH(NAME)   cocos2d::StringUtils::format("%s%s%s", STRING_CC_EVENT_LIS_ASSETS_MANAGER_EX, ":", (NAME)).c_str()
// lua_cocos2dx_extension_EventListenerAssetsManagerEx_%s
#define STRING_LUA_EVENT_LIS_ASSETS_MANAGER_EX_WITH(NAME)  cocos2d::StringUtils::format("%s%s%s", STRING_LUA_EVENT_LIS_ASSETS_MANAGER_EX, "_", (NAME)).c_str()

// invalid 'cobj' in function '%s'
#define STRING_INVALID_COBJ_IN(FUNC)                   cocos2d::StringUtils::format("invalid 'cobj' in function '%s'", (FUNC)).c_str()
// invalid arguments in function '%s'
#define STRING_INVALID_ARGS_IN(FUNC)                   cocos2d::StringUtils::format("invalid arguments in function '%s'", (FUNC)).c_str()
// #ferror in function '%s'
#define STRING_ERROR_IN(FUNC)                          cocos2d::StringUtils::format("#ferror in function '%s'.", (FUNC)).c_str()

#define STRING_FORMAT_2(A, B)                          cocos2d::StringUtils::format("%s%s", (A), (B)).c_str()
...
{
    std::string name = STRING_FORMAT_2("setStorage", "Path");
    int argc = 0;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,STRING_CC_ASSETS_MANAGER,0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,STRING_INVALID_COBJ_IN(STRING_LUA_ASSETS_MANAGER_WITH(name.c_str())), nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, STRING_CC_ASSETS_MANAGER_WITH(name.c_str())); arg0 = arg0_tmp.c_str();
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_ASSETS_MANAGER_WITH(name.c_str())), nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_ASSETS_MANAGER_WITH(name.c_str()),argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,STRING_ERROR_IN(STRING_LUA_ASSETS_MANAGER_WITH(name.c_str())),&tolua_err);
#endif
...
{
    std::string name = STRING_FORMAT_2("setPackage", "Url");
    int argc = 0;
    cocos2d::extension::AssetsManager* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("check", "Update");
    int argc = 0;
    cocos2d::extension::AssetsManager* cobj = nullptr;
    bool ok  = true;
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_ASSETS_MANAGER_WITH(name.c_str()),argc, 0);
    return 0;
...
{
    std::string name = STRING_FORMAT_2("getStorage", "Path");
    int argc = 0;
    cocos2d::extension::AssetsManager* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("setConnection", "Timeout");
    int argc = 0;
    cocos2d::extension::AssetsManager* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_uint32(tolua_S, 2,&arg0, STRING_CC_ASSETS_MANAGER_WITH(name.c_str()));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_ASSETS_MANAGER_WITH(name.c_str())), nullptr);
            return 0;
...
{
    std::string name = STRING_FORMAT_2("set", STRING_FORMAT_2("Version", STRING_FORMAT_2("File", "Url")));
    int argc = 0;
    cocos2d::extension::AssetsManager* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("getPackage", "Url");
    int argc = 0;
    cocos2d::extension::AssetsManager* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("getConnection", "Timeout");
    int argc = 0;
    cocos2d::extension::AssetsManager* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("get", "Version");
    int argc = 0;
    cocos2d::extension::AssetsManager* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("get", STRING_FORMAT_2("Version", STRING_FORMAT_2("File", "Url")));
    int argc = 0;
    cocos2d::extension::AssetsManager* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("delete", "Version");
    int argc = 0;
    cocos2d::extension::AssetsManager* cobj = nullptr;
    bool ok  = true;
...
int lua_cocos2dx_extension_AssetsManager_create(lua_State* tolua_S)
{
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,STRING_CC_ASSETS_MANAGER,0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 6)
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, STRING_CC_ASSETS_MANAGER_WITH(name.c_str())); arg0 = arg0_tmp.c_str();
        std::string arg1_tmp; ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, STRING_CC_ASSETS_MANAGER_WITH(name.c_str())); arg1 = arg1_tmp.c_str();
        std::string arg2_tmp; ok &= luaval_to_std_string(tolua_S, 4, &arg2_tmp, STRING_CC_ASSETS_MANAGER_WITH(name.c_str())); arg2 = arg2_tmp.c_str();
        do {
        ...
        object_to_luaval<cocos2d::extension::AssetsManager>(tolua_S, STRING_CC_ASSETS_MANAGER,(cocos2d::extension::AssetsManager*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", STRING_CC_ASSETS_MANAGER_WITH(name.c_str()),argc, 6);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,STRING_ERROR_IN(STRING_LUA_ASSETS_MANAGER_WITH(name.c_str())),&tolua_err);
...
int lua_cocos2dx_extension_AssetsManager_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,STRING_CC_ASSETS_MANAGER);
        return 1;
    }
    if (argc == 1) 
    {
        ...
        std::string arg0_tmp; ok &= luaval_to_std_string(tolua_S, 2, &arg0_tmp, STRING_CC_ASSETS_MANAGER_WITH(STRING_ASSETS_MANAGER)); arg0 = arg0_tmp.c_str();
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_ASSETS_MANAGER_WITH(name.c_str())), nullptr);
            return 0;
    ...
    if (argc == 2) 
    {
        ...
        std::string arg1_tmp; ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, STRING_CC_ASSETS_MANAGER_WITH(STRING_ASSETS_MANAGER)); arg1 = arg1_tmp.c_str();
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_ASSETS_MANAGER_WITH(name.c_str())), nullptr);
            return 0;
    ...
    if (argc == 3) 
    {
        ...
        std::string arg2_tmp; ok &= luaval_to_std_string(tolua_S, 4, &arg2_tmp, STRING_CC_ASSETS_MANAGER_WITH(STRING_ASSETS_MANAGER)); arg2 = arg2_tmp.c_str();
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_ASSETS_MANAGER_WITH(name.c_str())), nullptr);
            return 0;
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_ASSETS_MANAGER_WITH(STRING_ASSETS_MANAGER),argc, 0);
    return 0;
...
{
    tolua_usertype(tolua_S,STRING_CC_ASSETS_MANAGER);
    tolua_cclass(tolua_S,STRING_ASSETS_MANAGER,STRING_CC_ASSETS_MANAGER,"cc.Node",nullptr);

    tolua_beginmodule(tolua_S,STRING_ASSETS_MANAGER);
        tolua_function(tolua_S,"new",lua_cocos2dx_extension_AssetsManager_constructor);
        tolua_function(tolua_S,STRING_FORMAT_2("setStorage", "Path"),lua_cocos2dx_extension_AssetsManager_setStoragePath);
        tolua_function(tolua_S,STRING_FORMAT_2("setPackage", "Url"),lua_cocos2dx_extension_AssetsManager_setPackageUrl);
        tolua_function(tolua_S,STRING_FORMAT_2("check", "Update"),lua_cocos2dx_extension_AssetsManager_checkUpdate);
        tolua_function(tolua_S,STRING_FORMAT_2("getStorage", "Path"),lua_cocos2dx_extension_AssetsManager_getStoragePath);
        tolua_function(tolua_S,"update",lua_cocos2dx_extension_AssetsManager_update);
        tolua_function(tolua_S,STRING_FORMAT_2("setConnection", "Timeout"),lua_cocos2dx_extension_AssetsManager_setConnectionTimeout);
        tolua_function(tolua_S,STRING_FORMAT_2("set", STRING_FORMAT_2("Version", STRING_FORMAT_2("File", "Url"))),lua_cocos2dx_extension_AssetsManager_setVersionFileUrl);
        tolua_function(tolua_S,STRING_FORMAT_2("getPackage", "Url"),lua_cocos2dx_extension_AssetsManager_getPackageUrl);
        tolua_function(tolua_S,STRING_FORMAT_2("getConnection", "Timeout"),lua_cocos2dx_extension_AssetsManager_getConnectionTimeout);
        tolua_function(tolua_S,STRING_FORMAT_2("get", "Version"),lua_cocos2dx_extension_AssetsManager_getVersion);
        tolua_function(tolua_S,STRING_FORMAT_2("get", STRING_FORMAT_2("Version", STRING_FORMAT_2("File", "Url"))),lua_cocos2dx_extension_AssetsManager_getVersionFileUrl);
        tolua_function(tolua_S,STRING_FORMAT_2("delete", "Version"),lua_cocos2dx_extension_AssetsManager_deleteVersion);
    ...
    g_luaType[typeName] = STRING_CC_ASSETS_MANAGER;
    g_typeCast[STRING_ASSETS_MANAGER] = STRING_CC_ASSETS_MANAGER;
    return 1;
}

int lua_cocos2dx_extension_EventAssetsManagerEx_getAssetsManagerEx(lua_State* tolua_S)
{
    std::string name = STRING_FORMAT_2("get", STRING_ASSETS_MANAGER_EX);
    int argc = 0;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,STRING_CC_EVENT_ASSETS_MANAGER_EX,0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,STRING_INVALID_COBJ_IN(STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
        }
        cocos2d::extension::AssetsManagerEx* ret = cobj->getAssetsManagerEx();
        object_to_luaval<cocos2d::extension::AssetsManagerEx>(tolua_S, STRING_CC_ASSETS_MANAGER_EX,(cocos2d::extension::AssetsManagerEx*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str()),argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,STRING_ERROR_IN(STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str())),&tolua_err);
#endif
...
{
    std::string name = STRING_FORMAT_2("getAsset", "Id");
    int argc = 0;
    cocos2d::extension::EventAssetsManagerEx* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("getPercent", STRING_FORMAT_2("By", "File"));
    int argc = 0;
    cocos2d::extension::EventAssetsManagerEx* cobj = nullptr;
    bool ok  = true;
...
int lua_cocos2dx_extension_EventAssetsManagerEx_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(STRING_EVENT_ASSETS_MANAGER_EX));

        ok &= luaval_to_object<cocos2d::extension::AssetsManagerEx>(tolua_S, 3, STRING_CC_ASSETS_MANAGER_EX,&arg1, STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(STRING_EVENT_ASSETS_MANAGER_EX));

        ok &= luaval_to_int32(tolua_S, 4,(int *)&arg2, STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(STRING_EVENT_ASSETS_MANAGER_EX));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
        ...
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,STRING_CC_EVENT_ASSETS_MANAGER_EX);
        return 1;
    }
    if (argc == 4) 
    {
        ...
        ok &= luaval_to_number(tolua_S, 5,&arg3, STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(STRING_EVENT_ASSETS_MANAGER_EX));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
    ...
    if (argc == 5) 
    {
        ...
        ok &= luaval_to_number(tolua_S, 6,&arg4, STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(STRING_EVENT_ASSETS_MANAGER_EX));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
    ...
    if (argc == 6) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 7,&arg5, STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(STRING_EVENT_ASSETS_MANAGER_EX));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
    ...
    if (argc == 7) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 8,&arg6, STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(STRING_EVENT_ASSETS_MANAGER_EX));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
    ...
    if (argc == 8) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 9,(int *)&arg7, STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(STRING_EVENT_ASSETS_MANAGER_EX));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
    ...
    if (argc == 9) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 10,(int *)&arg8, STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(STRING_EVENT_ASSETS_MANAGER_EX));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_EVENT_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_EVENT_ASSETS_MANAGER_EX_WITH(STRING_EVENT_ASSETS_MANAGER_EX),argc, 3);
    return 0;
...
{
    tolua_usertype(tolua_S,STRING_CC_EVENT_ASSETS_MANAGER_EX);
    tolua_cclass(tolua_S,STRING_EVENT_ASSETS_MANAGER_EX,STRING_CC_EVENT_ASSETS_MANAGER_EX,"cc.EventCustom",nullptr);

    tolua_beginmodule(tolua_S,STRING_EVENT_ASSETS_MANAGER_EX);
        tolua_function(tolua_S,"new",lua_cocos2dx_extension_EventAssetsManagerEx_constructor);
    tolua_function(tolua_S,STRING_FORMAT_2("get", STRING_ASSETS_MANAGER_EX),lua_cocos2dx_extension_EventAssetsManagerEx_getAssetsManagerEx);
        tolua_function(tolua_S,STRING_FORMAT_2("getAsset", "Id"),lua_cocos2dx_extension_EventAssetsManagerEx_getAssetId);
    ...
    tolua_function(tolua_S,STRING_FORMAT_2("getPercent", STRING_FORMAT_2("By", "File")),lua_cocos2dx_extension_EventAssetsManagerEx_getPercentByFile);
    ...
    g_luaType[typeName] = STRING_CC_EVENT_ASSETS_MANAGER_EX;
    g_typeCast[STRING_EVENT_ASSETS_MANAGER_EX] = STRING_CC_EVENT_ASSETS_MANAGER_EX;
    return 1;
}

int lua_cocos2dx_extension_Manifest_getManifestFileUrl(lua_State* tolua_S)
{
    std::string name = STRING_FORMAT_2("get", STRING_FORMAT_2("Manifest", STRING_FORMAT_2("File", "Url")));
    int argc = 0;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,STRING_CC_MANIFEST,0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,STRING_INVALID_COBJ_IN(STRING_LUA_MANIFEST_WITH(name.c_str())), nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_MANIFEST_WITH(name.c_str())), nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_MANIFEST_WITH(name.c_str()),argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,STRING_ERROR_IN(STRING_LUA_MANIFEST_WITH(name.c_str())),&tolua_err);
#endif
...
{
    std::string name = STRING_FORMAT_2("is", STRING_FORMAT_2("Version", "Loaded"));
    int argc = 0;
    cocos2d::extension::Manifest* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("is", "Loaded");
    int argc = 0;
    cocos2d::extension::Manifest* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("get", STRING_FORMAT_2("Search", "Paths"));
    int argc = 0;
    cocos2d::extension::Manifest* cobj = nullptr;
    bool ok  = true;
...
{
    tolua_usertype(tolua_S,STRING_CC_MANIFEST);
    tolua_cclass(tolua_S,STRING_MANIFEST,STRING_CC_MANIFEST,"cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,STRING_MANIFEST);
        tolua_function(tolua_S,STRING_FORMAT_2("get", STRING_FORMAT_2("Manifest", STRING_FORMAT_2("File", "Url"))),lua_cocos2dx_extension_Manifest_getManifestFileUrl);
        tolua_function(tolua_S,STRING_FORMAT_2("is", STRING_FORMAT_2("Version", "Loaded")),lua_cocos2dx_extension_Manifest_isVersionLoaded);
    	tolua_function(tolua_S,STRING_FORMAT_2("is", "Loaded"),lua_cocos2dx_extension_Manifest_isLoaded);
        tolua_function(tolua_S,STRING_FORMAT_2("getPackage", "Url"),lua_cocos2dx_extension_Manifest_getPackageUrl);
        tolua_function(tolua_S,STRING_FORMAT_2("get", "Version"),lua_cocos2dx_extension_Manifest_getVersion);
        tolua_function(tolua_S,STRING_FORMAT_2("get", STRING_FORMAT_2("Version", STRING_FORMAT_2("File", "Url"))),lua_cocos2dx_extension_Manifest_getVersionFileUrl);
        tolua_function(tolua_S,STRING_FORMAT_2("get", STRING_FORMAT_2("Search", "Paths")),lua_cocos2dx_extension_Manifest_getSearchPaths);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(cocos2d::extension::Manifest).name();
    g_luaType[typeName] = STRING_CC_MANIFEST;
    g_typeCast[STRING_MANIFEST] = STRING_CC_MANIFEST;
    return 1;
}
...
int lua_cocos2dx_extension_AssetsManagerEx_getState(lua_State* tolua_S)
{
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,STRING_CC_ASSETS_MANAGER_EX,0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,STRING_INVALID_COBJ_IN(STRING_LUA_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
        }
        int ret = (int)cobj->getState();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_ASSETS_MANAGER_EX_WITH(name.c_str()),argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,STRING_ERROR_IN(STRING_LUA_ASSETS_MANAGER_EX_WITH(name.c_str())),&tolua_err);
#endif
...
{
    std::string name = "getMaxConcurrentTask";
    int argc = 0;
    cocos2d::extension::AssetsManagerEx* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("set", STRING_FORMAT_2("Verify", "Callback"));
    int argc = 0;
    cocos2d::extension::AssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_ASSETS_MANAGER_EX_WITH(name.c_str()),argc, 1);
    return 0;
...
{
    std::string name = STRING_FORMAT_2("set", STRING_FORMAT_2("Version", STRING_FORMAT_2("Compare", "Handle")));
    int argc = 0;
    cocos2d::extension::AssetsManagerEx* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = "setMaxConcurrentTask";
    int argc = 0;
    cocos2d::extension::AssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, STRING_CC_ASSETS_MANAGER_EX_WITH(name.c_str()));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
...
{
    std::string name = STRING_FORMAT_2("get", STRING_FORMAT_2("Local", "Manifest"));
    int argc = 0;
    cocos2d::extension::AssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        ...
        object_to_luaval<cocos2d::extension::Manifest>(tolua_S, STRING_CC_MANIFEST,(cocos2d::extension::Manifest*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_ASSETS_MANAGER_EX_WITH(name.c_str()),argc, 0);
    return 0;
...
{
    std::string name = STRING_FORMAT_2("get", STRING_FORMAT_2("Remote", "Manifest"));
    int argc = 0;
    cocos2d::extension::AssetsManagerEx* cobj = nullptr;
    bool ok  = true;
...
{
    std::string name = STRING_FORMAT_2("download", STRING_FORMAT_2("Failed", "Assets"));
    int argc = 0;
    cocos2d::extension::AssetsManagerEx* cobj = nullptr;
    bool ok  = true;
...
int lua_cocos2dx_extension_AssetsManagerEx_create(lua_State* tolua_S)
{
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,STRING_CC_ASSETS_MANAGER_EX,0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 2)
    {
        std::string arg0;
        std::string arg1;
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, STRING_CC_ASSETS_MANAGER_EX_WITH(name.c_str()));
        ok &= luaval_to_std_string(tolua_S, 3,&arg1, STRING_CC_ASSETS_MANAGER_EX_WITH(name.c_str()));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", STRING_CC_ASSETS_MANAGER_EX_WITH(name.c_str()),argc, 2);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,STRING_ERROR_IN(STRING_LUA_ASSETS_MANAGER_EX_WITH(name.c_str())),&tolua_err);
...
int lua_cocos2dx_extension_AssetsManagerEx_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, STRING_CC_ASSETS_MANAGER_EX_WITH(STRING_ASSETS_MANAGER_EX));

        ok &= luaval_to_std_string(tolua_S, 3,&arg1, STRING_CC_ASSETS_MANAGER_EX_WITH(STRING_ASSETS_MANAGER_EX));
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_COBJ_IN(STRING_LUA_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
        ...
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,STRING_CC_ASSETS_MANAGER_EX);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_ASSETS_MANAGER_EX_WITH(STRING_ASSETS_MANAGER_EX),argc, 2);
    return 0;
...
{
    tolua_usertype(tolua_S,STRING_CC_ASSETS_MANAGER_EX);
    tolua_cclass(tolua_S,STRING_ASSETS_MANAGER_EX,STRING_CC_ASSETS_MANAGER_EX,"cc.Ref",nullptr);

    tolua_beginmodule(tolua_S,STRING_ASSETS_MANAGER_EX);
        ...
        tolua_function(tolua_S,STRING_FORMAT_2("check", "Update"),lua_cocos2dx_extension_AssetsManagerEx_checkUpdate);
        tolua_function(tolua_S,STRING_FORMAT_2("set", STRING_FORMAT_2("Verify", "Callback")),lua_cocos2dx_extension_AssetsManagerEx_setVerifyCallback);
        tolua_function(tolua_S,STRING_FORMAT_2("getStorage", "Path"),lua_cocos2dx_extension_AssetsManagerEx_getStoragePath);
        tolua_function(tolua_S,"update",lua_cocos2dx_extension_AssetsManagerEx_update);
        tolua_function(tolua_S,STRING_FORMAT_2("set", STRING_FORMAT_2("Version", STRING_FORMAT_2("Compare", "Handle"))),lua_cocos2dx_extension_AssetsManagerEx_setVersionCompareHandle);
        tolua_function(tolua_S,"setMaxConcurrentTask",lua_cocos2dx_extension_AssetsManagerEx_setMaxConcurrentTask);
        tolua_function(tolua_S,STRING_FORMAT_2("get", STRING_FORMAT_2("Local", "Manifest")),lua_cocos2dx_extension_AssetsManagerEx_getLocalManifest);
        tolua_function(tolua_S,STRING_FORMAT_2("get", STRING_FORMAT_2("Remote", "Manifest")),lua_cocos2dx_extension_AssetsManagerEx_getRemoteManifest);
        tolua_function(tolua_S,STRING_FORMAT_2("download", STRING_FORMAT_2("Failed", "Assets")),lua_cocos2dx_extension_AssetsManagerEx_downloadFailedAssets);
    ...
    g_luaType[typeName] = STRING_CC_ASSETS_MANAGER_EX;
    g_typeCast[STRING_ASSETS_MANAGER_EX] = STRING_CC_ASSETS_MANAGER_EX;
    return 1;
}
...
int lua_cocos2dx_extension_EventListenerAssetsManagerEx_init(lua_State* tolua_S)
{
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,STRING_CC_EVENT_LIS_ASSETS_MANAGER_EX,0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,STRING_INVALID_COBJ_IN(STRING_LUA_EVENT_LIS_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_object<const cocos2d::extension::AssetsManagerEx>(tolua_S, 2, STRING_CC_ASSETS_MANAGER_EX,&arg0,  STRING_CC_EVENT_LIS_ASSETS_MANAGER_EX_WITH(name.c_str()));
        ...
        if(!ok)
        {
            tolua_error(tolua_S,STRING_INVALID_ARGS_IN(STRING_LUA_EVENT_LIS_ASSETS_MANAGER_EX_WITH(name.c_str())), nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_EVENT_LIS_ASSETS_MANAGER_EX_WITH(name.c_str()),argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,STRING_ERROR_IN(STRING_LUA_EVENT_LIS_ASSETS_MANAGER_EX_WITH(name.c_str())),&tolua_err);
#endif
...
int lua_cocos2dx_extension_EventListenerAssetsManagerEx_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
        toluafix_pushusertype_ccobject(tolua_S, ID, luaID, (void*)cobj,STRING_CC_EVENT_LIS_ASSETS_MANAGER_EX);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", STRING_CC_EVENT_LIS_ASSETS_MANAGER_EX_WITH(STRING_EVENT_LIS_ASSETS_MANAGER_EX),argc, 0);
    return 0;
...
{
    std::string strListener = STRING_FORMAT_2("EventListener", STRING_ASSETS_MANAGER_EX);
    std::string strCcListener = STRING_FORMAT_2("cc.EventListener", STRING_ASSETS_MANAGER_EX);
    tolua_usertype(tolua_S,strCcListener.c_str());
    tolua_cclass(tolua_S,strListener.c_str(),strCcListener.c_str(),"cc.EventListenerCustom",nullptr);

    tolua_beginmodule(tolua_S,strListener.c_str());
    ...
    g_luaType[typeName] = strCcListener.c_str();
    g_typeCast[strListener.c_str()] = strCcListener.c_str();
    return 1;
}
