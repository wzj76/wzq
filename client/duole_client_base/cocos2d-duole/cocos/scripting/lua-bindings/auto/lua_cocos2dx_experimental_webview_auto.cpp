...
int lua_cocos2dx_experimental_webview_WebView_setPlayback(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_webview_WebView_setPlayback'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1)
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "ccexp.WebView:Playback");

        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_webview_WebView_setPlayback'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccexp.WebView:setPlayback",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_webview_WebView_setPlayback'.",&tolua_err);
#endif

    return 0;
}

int lua_cocos2dx_experimental_webview_WebView_setMenuBack(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::WebView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_webview_WebView_setMenuBack'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2)
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "ccexp.WebView:path");
        
        double arg1;
        ok &= luaval_to_number(tolua_S, 3, &arg1, "ccexp.WebView:width");

        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_webview_WebView_setMenuBack'", nullptr);
            return 0;
        }
        cobj->setMenuBack(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccexp.WebView:setMenuBack",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_webview_WebView_setMenuBack'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_experimental_webview_WebView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"WebView");
        ...
        tolua_function(tolua_S,"setPlayback",lua_cocos2dx_experimental_webview_WebView_setPlayback);
        tolua_function(tolua_S,"setMenuBack",lua_cocos2dx_experimental_webview_WebView_setMenuBack);
