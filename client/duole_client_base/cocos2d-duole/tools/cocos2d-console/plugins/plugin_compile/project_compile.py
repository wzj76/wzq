...
class CCPluginCompile(cocos.CCPlugin):
    ...
    def _add_custom_options(self, parser):
        ...
        # by zhangjm
        # add channel args
        parser.add_argument("-c", "--channel", dest="channel", default='debugger',
                  help=MultiLanguage.get_string('COMPILE_ARG_CHANNEL'))
        # add channel-group args
        parser.add_argument("-g", "--channel-group", dest="channel_group", default='duole',
                  help=MultiLanguage.get_string('COMPILE_ARG_CHANNEL_GROUP'))
    ...
    def _check_custom_options(self, args):
        ...
        self._channel_group = args.channel_group
    ...
    def build_android(self):
        ...
        self.apk_path = builder.do_build_apk(self._channel, self._channel_group, build_mode, self._no_apk, self._no_sign, output_dir, self._custom_step_args, self._ap, self)
