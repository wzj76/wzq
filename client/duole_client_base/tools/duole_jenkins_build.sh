...
mv ${APP_ANDROID_HOME}/dists/${arg5}/*.apk $published_dir/

# Archive the artifacts:jenkins归档，方便下载；
JENKINS_WORKSPACE="/Users/$(whoami)/.jenkins/jobs"
ARCHIVE_PATH="${JENKINS_WORKSPACE}/${arg4}/workspace"
if [ ! -d "$ARCHIVE_PATH" ]
then
