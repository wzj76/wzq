//
//  BeatingModeScene.hpp
//  wzqgame-mobile
//
//  Created by moe on 2024/1/31.
//

#ifndef BeatingModeScene_hpp
#define BeatingModeScene_hpp
...
class BeatingModeScene : public BaseInGameScene, WZQEventWrapper
{
public:
